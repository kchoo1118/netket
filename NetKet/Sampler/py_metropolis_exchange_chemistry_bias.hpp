...
#ifndef NETKET_PY_METROPOLISEXCHANGECHEMBIAS_HPP
#define NETKET_PY_METROPOLISEXCHANGECHEMBIAS_HPP
...
void AddMetropolisExchangeChemistryBias(py::module &subm) {
  using DerSampler = MetropolisExchangeChemistryBias<AbstractOperator>;
  py::class_<DerSampler, AbstractSampler>(subm,
                                          "MetropolisExchangeChemistryBias",
                                          R"EOF(
    ...
    of the Hamiltonian. This is in generally not true for the local samplers instead.
      ...
      .def(py::init<AbstractMachine &, AbstractOperator &, int, int,
                    std::string, bool, bool, bool, bool, double>(),
           py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::arg("machine"),
           py::arg("hamiltonian"), py::arg("npar"), py::arg("njumps"),
           py::arg("mapping"), py::arg("adaptive_sweep"), py::arg("rand_tran"),
           py::arg("conserve_spin"), py::arg("particle_hole"),
           py::arg("gamma_bias") = 0.0, R"EOF(
