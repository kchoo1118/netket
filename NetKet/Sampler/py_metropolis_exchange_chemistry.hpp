...
#ifndef NETKET_PY_METROPOLISEXCHANGECHEM_HPP
#define NETKET_PY_METROPOLISEXCHANGECHEM_HPP
...
void AddMetropolisExchangeChemistry(py::module &subm) {
  using DerSampler = MetropolisExchangeChemistry<AbstractOperator>;
  py::class_<DerSampler, AbstractSampler>(subm, "MetropolisExchangeChemistry",
                                          R"EOF(
