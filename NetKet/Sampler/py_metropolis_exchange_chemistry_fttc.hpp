...
#ifndef NETKET_PY_METROPOLISEXCHANGECHEM_FTTC_HPP
#define NETKET_PY_METROPOLISEXCHANGECHEM_FTTC_HPP

#include <pybind11/pybind11.h>
#include "metropolis_exchange_chemistry_fttc.hpp"

namespace py = pybind11;

namespace netket {

void AddMetropolisExchangeChemistryFTTC(py::module &subm) {
  using DerSampler = MetropolisExchangeChemistryFTTC<AbstractOperator>;
  py::class_<DerSampler, AbstractSampler>(subm,
                                          "MetropolisExchangeChemistryFTTC",
                                          R"EOF(
    ...
    of the Hamiltonian. This is in generally not true for the local samplers instead.
      ...
      .def(py::init<AbstractMachine &, int, std::string, bool>(),
           py::keep_alive<1, 2>(), py::keep_alive<1, 3>(), py::arg("machine"),
           py::arg("npar"), py::arg("mapping"), py::arg("particle_hole"), R"EOF(
