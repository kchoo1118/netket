...
#ifndef NETKET_PYVARIATIONALMONTECARLOEXACT_HPP
#define NETKET_PYVARIATIONALMONTECARLOEXACT_HPP
...
void AddVariationalMonteCarloExactModule(py::module &m) {
  auto m_vmc = m.def_submodule("variational");

  py::class_<VariationalMonteCarloExact>(
      m_vmc, "VmcExact",
      R"EOF(Exact Variational Monte Carlo schemes to learn the ground state using stochastic reconfiguration and gradient descent optimizers.)EOF")
      .def(py::init<const AbstractOperator &, AbstractMachine &,
                    AbstractOptimizer &, const std::string &, double, bool,
                    bool>(),
           py::keep_alive<1, 2>(), py::keep_alive<1, 3>(),
           py::keep_alive<1, 4>(), py::arg("hamiltonian"), py::arg("machine"),
           py::arg("optimizer"), py::arg("method") = "Sr",
           py::arg("diag_shift") = 0.01, py::arg("use_iterative") = false,
           py::arg("use_cholesky") = true,
           R"EOF(
           Constructs a ``VariationalMonteCarloExact`` object given a hamiltonian,
      ...
      .def_property_readonly(
          "machine", &VariationalMonteCarloExact::GetMachine,
          R"EOF(netket.machine.Machine: The machine used to express the wavefunction.)EOF")
      .def("add_observable", &VariationalMonteCarloExact::AddObservable,
      ...
      .def("run", &VariationalMonteCarloExact::Run, py::arg("output_prefix"),
      ...
      .def("iter", &VariationalMonteCarloExact::Iterate,
           py::arg("n_iter") = nonstd::nullopt, py::arg("step_size") = 1,
      ...
      .def("advance", &VariationalMonteCarloExact::Advance,
           py::arg("steps") = 1, py::arg("clip") = 100,
           R"EOF(
      ...
      .def("get_observable_stats",
           [](VariationalMonteCarloExact &self) {
             py::dict data;
  ...
  py::class_<VariationalMonteCarloExact::Iterator>(m_vmc, "VmcExactIterator")
      .def("__iter__", [](VariationalMonteCarloExact::Iterator &self) {
