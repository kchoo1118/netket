...
#ifndef NETKET_PYVARIATIONALMONTECARLOCACHE_HPP
#define NETKET_PYVARIATIONALMONTECARLOCACHE_HPP
...
#include <complex>
#include <vector>
#include "variational_montecarlo_cache.hpp"

namespace py = pybind11;

namespace netket {

void AddVariationalMonteCarloCacheModule(py::module &m) {
  auto m_vmc = m.def_submodule("variational");

  py::class_<VariationalMonteCarloCache>(
      m_vmc, "VmcCache",
      ...
      .def(py::init<const AbstractOperator &, AbstractSampler &,
           ...
           R"EOF(
           Constructs a ``VariationalMonteCarloCache`` object given a hamiltonian,
      ...
      .def_property_readonly(
          "machine", &VariationalMonteCarloCache::GetMachine,
          R"EOF(netket.machine.Machine: The machine used to express the wavefunction.)EOF")
      .def("add_observable", &VariationalMonteCarloCache::AddObservable,
      ...
      .def("run", &VariationalMonteCarloCache::Run, py::arg("output_prefix"),
      ...
      .def("iter", &VariationalMonteCarloCache::Iterate,
           py::arg("n_iter") = nonstd::nullopt, py::arg("step_size") = 1,
      ...
      .def("advance", &VariationalMonteCarloCache::Advance,
      ...
      .def("get_observable_stats",
           [](VariationalMonteCarloCache &self) {
             py::dict data;
  ...
  py::class_<VariationalMonteCarloCache::Iterator>(m_vmc, "VmcCacheIterator")
      .def("__iter__", [](VariationalMonteCarloCache::Iterator &self) {
