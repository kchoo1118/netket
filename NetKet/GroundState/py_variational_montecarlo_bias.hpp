...
#ifndef NETKET_PYVARIATIONALMONTECARLOBIAS_HPP
#define NETKET_PYVARIATIONALMONTECARLOBIAS_HPP
...
void AddVariationalMonteCarloBiasModule(py::module &m) {
  auto m_vmc = m.def_submodule("variational");

  py::class_<VariationalMonteCarloBias>(
      m_vmc, "VmcBias",
      ...
      .def_property_readonly(
          "machine", &VariationalMonteCarloBias::GetMachine,
          R"EOF(netket.machine.Machine: The machine used to express the wavefunction.)EOF")
      .def("add_observable", &VariationalMonteCarloBias::AddObservable,
      ...
      .def("run", &VariationalMonteCarloBias::Run, py::arg("output_prefix"),
      ...
      .def("iter", &VariationalMonteCarloBias::Iterate,
           py::arg("n_iter") = nonstd::nullopt, py::arg("step_size") = 1,
      ...
      .def("advance", &VariationalMonteCarloBias::Advance, py::arg("steps") = 1,
           py::arg("clip") = 100,
           R"EOF(
      ...
      .def("get_observable_stats",
           [](VariationalMonteCarloBias &self) {
             py::dict data;
  ...
  py::class_<VariationalMonteCarloBias::Iterator>(m_vmc, "VmcBiasIterator")
      .def("__iter__", [](VariationalMonteCarloBias::Iterator &self) {
