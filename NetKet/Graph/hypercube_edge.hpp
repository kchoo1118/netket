...
#ifndef NETKET_HYPERCUBEEDGE_HPP
#define NETKET_HYPERCUBEEDGE_HPP
...
class HypercubeEdge : public AbstractGraph {
 ...
 public:
  HypercubeEdge(HypercubeEdge const &) = delete;
  HypercubeEdge(HypercubeEdge &&) noexcept = default;
  HypercubeEdge &operator=(HypercubeEdge const &) noexcept = delete;
  HypercubeEdge &operator=(HypercubeEdge &&) noexcept = default;

  HypercubeEdge(int const length, int const n_dim = 1, bool pbc = true)
