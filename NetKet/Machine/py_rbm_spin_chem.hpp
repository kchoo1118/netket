...
#ifndef NETKET_PYRBMSPINCHEM_HPP
#define NETKET_PYRBMSPINCHEM_HPP
...
void AddRbmSpinChem(py::module &subm) {
  py::class_<RbmSpinChem, AbstractMachine>(subm, "RbmSpinChem", R"EOF(
      ...
      .def(py::init<const AbstractHilbert &, int, int, bool, bool>(),
           ...
           R"EOF(
                   Constructs a new ``RbmSpinChem`` machine:
