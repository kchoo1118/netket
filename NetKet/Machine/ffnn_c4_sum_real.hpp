...
#ifndef NETKET_FFNNC4SUMREAL_HPP
#define NETKET_FFNNC4SUMREAL_HPP

namespace netket {

template <typename T>
class FFNNC4SumReal : public AbstractMachine<T> {
 ...
 public:
  ...
  // constructor
  explicit FFNNC4SumReal(const Graph &graph, const Hilbert &hilbert,
                         const json &pars)
      : nv_(hilbert.Size()),
        hilbert_(hilbert),
        graph_(graph),
