...
#ifndef NETKET_PYCONFIGURATION_HPP
#define NETKET_PYCONFIGURATION_HPP
...
void AddConfiguration(py::module &subm) {
  py::class_<Configuration, AbstractMachine>(subm, "Configuration", R"EOF(
