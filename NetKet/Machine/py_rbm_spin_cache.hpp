...
#ifndef NETKET_PYRBMSPINCACHE_HPP
#define NETKET_PYRBMSPINCACHE_HPP
...
#include <complex>
#include <vector>
#include "rbm_spin_cache.hpp"

namespace py = pybind11;

namespace netket {

void AddRbmSpinCache(py::module &subm) {
  py::class_<RbmSpinCache, AbstractMachine>(subm, "RbmSpinCache", R"EOF(
